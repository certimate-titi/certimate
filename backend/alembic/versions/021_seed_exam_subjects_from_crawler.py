...
3 categories, 14 subjects from CertiMate historical exam database.
"""
...
CATEGORY_IDS = {
    "金融證照": uuid.UUID("a0000001-0000-0000-0000-000000000001"),
    "不動產證照": uuid.UUID("a0000001-0000-0000-0000-000000000002"),
    "iPAS 產業人才鑑定": uuid.UUID("a0000001-0000-0000-0000-000000000003"),
}

SUBJECT_DATA = [
    # (uuid, category_key, name, name_en, description, is_popular)
    # ── 金融證照 ──
    ("b0000001-0001-0000-0000-000000000001", "金融證照",
     "信託業業務人員", "Trust Business Personnel",
     "台灣金融研訓院 (TABF) — 信託業務專業測驗", True),
    ("b0000001-0002-0000-0000-000000000002", "金融證照",
     "證券商業務員", "Securities Salesperson",
     "證券暨期貨市場發展基金會 (SFI) — 證券交易相關法規與實務", True),
    ("b0000001-0003-0000-0000-000000000003", "金融證照",
     "人身保險業務員", "Life Insurance Agent",
     "台灣金融研訓院 (TABF) — 人身保險業務員資格測驗", True),
    ("b0000001-0004-0000-0000-000000000004", "金融證照",
     "期貨商業務員", "Futures Salesperson",
     "證券暨期貨市場發展基金會 (SFI) — 期貨交易法規與實務", True),
    ("b0000001-0005-0000-0000-000000000005", "金融證照",
     "防制洗錢與打擊資恐專業人員", "AML/CFT Professional",
     "證券暨期貨市場發展基金會 (SFI) — 防制洗錢與打擊資恐法令及實務", True),
    ("b0000001-0006-0000-0000-000000000006", "金融證照",
     "理財規劃人員", "Financial Planner",
     "台灣金融研訓院 (TABF) — 理財規劃人員專業能力測驗", True),

    # ── 不動產證照 ──
    ("b0000002-0001-0000-0000-000000000001", "不動產證照",
     "不動產經紀人", "Real Estate Broker",
     "考選部 — 不動產經紀人專技普考", True),
    ("b0000002-0002-0000-0000-000000000002", "不動產證照",
     "地政士", "Land Agent",
     "考選部 — 地政士專技普考", True),
    ("b0000002-0003-0000-0000-000000000003", "不動產證照",
     "不動產估價師", "Real Estate Appraiser",
     "考選部 — 不動產估價師專技高考", False),

    # ── iPAS 產業人才鑑定 ──
    ("b0000003-0001-0000-0000-000000000001", "iPAS 產業人才鑑定",
     "AI 應用規劃師", "AI Application Planner",
     "經濟部產業發展署 iPAS — 人工智慧應用規劃師能力鑑定", True),
    ("b0000003-0002-0000-0000-000000000002", "iPAS 產業人才鑑定",
     "巨量資料分析師", "Big Data Analyst",
     "經濟部產業發展署 iPAS — 巨量資料分析師能力鑑定", False),
    ("b0000003-0003-0000-0000-000000000003", "iPAS 產業人才鑑定",
     "物聯網應用工程師", "IoT Application Engineer",
     "經濟部產業發展署 iPAS — 物聯網應用工程師能力鑑定", False),
    ("b0000003-0004-0000-0000-000000000004", "iPAS 產業人才鑑定",
     "區塊鏈智能合約開發者", "Blockchain Smart Contract Developer",
     "經濟部產業發展署 iPAS — 區塊鏈智能合約開發者能力鑑定", False),
    ("b0000003-0005-0000-0000-000000000005", "iPAS 產業人才鑑定",

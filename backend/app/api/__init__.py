...
from app.api.user_tags import router as user_tags_router
...
router.include_router(user_notes_router, tags=["user-notes"])
router.include_router(user_tags_router, tags=["user-tags"])

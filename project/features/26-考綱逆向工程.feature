...
Feature: 考綱逆向工程
  ...
  # 主要觸發點改為「考古題 ImportTask 完成時系統自動執行」，
  # super-admin UI 已移除（commit 6fd15ac）；

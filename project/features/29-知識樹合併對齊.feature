...
Feature: 知識樹合併對齊
  ...
  術語定義（與 Feature 03/04/26/27 統一）：
    - 前端 UX：「知識心智圖」（統一用語）
    - 後端 DB/API：knowledge_nodes（統一表，node_type 欄位區分）
    - 考科官方知識架構（本 Feature 操作目標）：node_type = syllabus
    - 用戶個人學習節點（Feature 03/04/27 操作目標）：node_type = personal
